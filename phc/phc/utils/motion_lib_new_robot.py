...
from phc.utils.flags import flags
from phc.utils.motion_lib_base import MotionLibBase, DeviceCache, compute_motion_dof_vels, FixHeightMode
from phc.utils.torch_new_robot_humanoid_batch import New_Robot_Humanoid_Batch
from easydict import EasyDict
...
class MotionLibNewRobot(MotionLibBase):

    def __init__(self, motion_file, device, fix_height=FixHeightMode.no_fix, masterfoot_conifg=None, min_length=-1, im_eval=False, multi_thread=True, extend_hand = True, extend_head = False, mjcf_file="resources/robots/h1_2/h1_2.xml", sim_timestep = 1/50):    # TODO:替换为新的Robot的mjcf文件
        ...
        self.mesh_parsers = New_Robot_Humanoid_Batch(extend_hand = extend_hand, extend_head = extend_head, mjcf_file=mjcf_file)
        return
